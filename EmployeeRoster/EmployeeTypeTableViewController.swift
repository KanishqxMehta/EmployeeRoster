...
//  EmployeeRoster
//
//  Created by Kanishq Mehta on 25/11/24.
//
...
//     MARK: - Table view data source
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        content.text = EmployeeType.allCases[indexPath.row].description
        cell.contentConfiguration = content
        
        if employeeType == EmployeeType.allCases[indexPath.row] {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.employeeTypeTableViewController(self, didSelect: self.employeeType!)
